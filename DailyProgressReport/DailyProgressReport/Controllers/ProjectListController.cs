...
using System.Linq;
using DailyProgressReport.Models; // Replace with your actual model namespace
...
namespace DailyProgressReport.Controllers
{
    public class ProjectListController : Controller
    {
        ...
        {
            // Your ADO.NET code to call the stored procedure or query to update the project status
            // Example code:
            using (SqlConnection connection = new SqlConnection(_configuration.GetConnectionString("ConnectionString")))
            {
                connection.Open();
